...
class MyDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, uid):
        ...
        # seq 形如 array[0, 0, 0, 831, 12042, 40321...]
        # pos 形如 array[0, 0, 0, 12042, 40321, 45694...]
        # neg 形如 array[0, 0, 0, 41507, 314, 56063...]
        # token_type 形如 array[0, 0, 0, 2, 1, 1,...]
        # next_token_type 形如 array[0, 0, 0, 1, 1, 1,...]
        # next_action_type 形如 array[0, 0, 0, 1, 0, 1,...]
        # seq_feat 形如
        '''
        seq_feat[0]: {'103': 0, '104':0, ..., '106':[0], '110': [0], ..., '81', array[0,..0,...0]}
        seq_feat[1]: {'103': 0, '104':0, ..., '106':[0], '110': [0], ..., '81', array[0,..0,...0]}
        seq_feat[2]: {'103': 0, '104':0, ..., '106':[0], '110': [0], ..., '81', array[0,..0,...0]}
        seq_feat[3]: {'103: 30, '104':2, ..., '106':[6, 4, 3, 10], '110':[2,1], ..., '81', array[0,..0,...0]}
        seq_feat[4]: {'112': 22, '117':62, ..., '106':[0], '110': [0], ..., '81', array[0,..0,...0]}
        '''
        # pos_feat 形如
        '''
        pos_feat[0]: {'103': 0, '104':0, ..., '106':[0], '110': [0], ..., '81', array[0,..0,...0]}
        pos_feat[1]: {'103': 0, '104':0, ..., '106':[0], '110': [0], ..., '81', array[0,..0,...0]}
        pos_feat[2]: {'103': 0, '104':0, ..., '106':[0], '110': [0], ..., '81', array[0,..0,...0]}
        pos_feat[4]: {'112': 22, '117':62, ..., '106':[0], '110': [0], ..., '81', array[0,..0,...0]}
        '''
        # neg_feat 形如
        '''
        neg_feat[0]: {'103': 0, '104':0, ..., '106':[0], '110': [0], ..., '81', array[0,..0,...0]}
        neg_feat[1]: {'103': 0, '104':0, ..., '106':[0], '110': [0], ..., '81', array[0,..0,...0]}
        neg_feat[2]: {'103': 0, '104':0, ..., '106':[0], '110': [0], ..., '81', array[0,..0,...0]}
        neg_feat[3]: {'112': 20, '117':117, ..., '106':[0], '110': [0], ..., }
        '''
